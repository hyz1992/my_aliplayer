...
class MyAliplayer {
  ...
  static void openVideoActivity()async{
    await _channel.invokeMethod('openVideoActivity');
  }
}
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  Future<void> _applyVolume() async {
    ...
    await _channel.invokeMethod(
      'setVolume',
      <String, dynamic>{'textureId': _textureId, 'volume': (value.volume*100)~/1},
    );
  }
  ...
  Future<void> setVolume(double volume) async {
    value = value.copyWith(volume: volume.clamp(0.0, 100.0));
    await _applyVolume();
  }
}
